...
give them more time to fish. But children dislike sitting in silence for long
...
Before we examine the coefficients, we can check if our model can replicate the overall pattern of fish
...
pp_check(object = fit_fisher1, type = "hist", ndraws = 3, binwidth = 1) +
