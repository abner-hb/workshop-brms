...
parameters. Understanding where the values above come from requires a taste of
Bayesian statistics that we will savour soon. For now, though, we can summarize
our results as follows, focusing on the table of regression coefficients.
...
grasp if we devote a little time to learning the "bayesics" of Bayesian
