...
above 400 in most models, or at least 100 for special parameters in complicated
models. Our penguin model above has way more ESS than this: the lowest Bulk ESS
is 3794 (for the `Intercept`) and the lowest Tail ESS is 2698 (for the standard
deviation `sigma`).
